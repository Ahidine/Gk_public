<template>
	<div>
		<a class="btn btn-success btn-link add float-center" data-toggle="modal" data-target="#addModule" > 
							...
							<div class="col-sm-2 checkbox-radios"  >
								<div class="form-check form-check-inline">      
									<label class="form-check-label ">
										...
										<input class="form-check-input" name="module_id[]" type="checkbox" :checked="mod_id.includes(m.id)" :value=" m.id">
