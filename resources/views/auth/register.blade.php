                  ...
                  <div class="input-group">
                    <div class="input-group-prepend">
                      ...
                      <select class="selectpicker" style="display:inline-block" name="user_type" data-style="select-with-transition" title="" data-size="100">
                        ...
                        <option value="1" @if (old('user_type') == '1') selected="selected" @endif>{{ __('Responsable') }}</option>
                        <option value="2" @if (old('user_type') == '2') selected="selected" @endif>{{ __('Professeur') }}</option>
                        <option value="3" @if (old('user_type') == '3') selected="selected" @endif>{{ __('Eleve') }}</option>
                        <option value="4" @if (old('user_type') == '4') selected="selected" @endif>{{ __('Responsable Commerciale') }}</option>
                        <option value="5" @if (old('user_type') == '5') selected="selected" @endif>{{ __('Responsable pedagogique') }}</option>
                        <option value="6" @if (old('user_type') == '6') selected="selected" @endif>{{ __('Admin') }}</option>
                      </select>
