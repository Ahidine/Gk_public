...
<div class="container">
    <div class="row">
      <div class="col-md-9 ml-auto mr-auto mb-1 text-center">
        <h3>{{ __('Welcome to Genuis Kides ERP.') }} </h3>
        ...
        <form class="form" method="POST" action="{{ route('login') }}">
          ...
          <div class="card card-login card-hidden">
            ...
            <div class="card-body ">
              <span class="form-group  bmd-form-group{{ $errors->has('email') ? ' has-danger' : '' }}" >
                <div class="input-group">
                  ...
                  <input type="email" class="form-control" id="exampleEmails" name="email" placeholder="{{ __('Email...') }}" value="{{ old('email', 'admin@gmail.com') }}" required>
            ...
            <div class="card-footer justify-content-center">
              <button type="submit" class="btn btn-rose btn-link btn-lg">{{ __('Se connecter') }}</button>
            </div>
          </div>
        </form>
        <div class="row">
