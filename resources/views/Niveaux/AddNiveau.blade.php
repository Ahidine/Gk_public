...
<div class="col-md-12" style="margin-top: 100px;">
  ...
  <div class="card ">
    <div class="card-header card-header-rose card-header-text">
      <div class="card-text">
        <h4 class="card-title">Ajout d'un du niveau </h4>
      </div>
    </div>
    <div class="card-body ">
      <form method="post" action="{{ route('Niveau.store') }}" autocomplete="off" class="form-horizontal">
        @csrf
        @method('post')
          ...
          <div class="card card-collapse">
           ...
           <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
            ...
            <div class="row">
              ...
              <div class="col-sm-10">
                <div class="form-group">
                 <input name="min_age" type="number"   class="form-control" required>
               </div>
             </div>
           </div>
           <div class="row">
            ...
            <div class="col-sm-10">
              <div class="form-group">
               <input name="max_age" type="number"  class="form-control" required>
             </div>
           </div>
         </div>
       </div>
  ...
  <div class="card card-collapse">
    ...
    <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
      <div class="card-body">
       <div class="col-md-12">
        <div id="appseconde">
        <addmodule-component :modules="{{$modules}}" > </addmodule-component>          
        </div>
